...
// AccountUserFieldsUpdateRequest2 account user fields update request2
//
// swagger:model AccountUserFieldsUpdateRequest2
type AccountUserFieldsUpdateRequest2 struct {
	...
	//  Max length = 20, Credit application user field 2. User-defined information about the account holder's credit application
	// Max Length: 20
	// Min Length: 0
	...
	//  Max length = 1, Suspense Status
	// Max Length: 1
	// Min Length: 0
	SuspenseStatus *string `json:"suspenseStatus,omitempty"`

	//  Max length = 1, Suspense Waiver Flag.
	// Max Length: 1
	// Min Length: 0
	// Pattern: ^[0-9]*$
	SuspenseWaiverFlag *string `json:"suspenseWaiverFlag,omitempty"`
	...
	// Format: YYYYMMDD. User defined date 1. User-defined dates used for customized information about the account.
	UserDate1 string `json:"userDate1,omitempty"`

	// Format: YYYYMMDD. User defined date 10. User-defined dates used for customized information about the account.
	UserDate10 string `json:"userDate10,omitempty"`

	// Format: YYYYMMDD. User defined date 11. User-defined dates used for customized information about the account.
	UserDate11 string `json:"userDate11,omitempty"`

	// Format: YYYYMMDD. User defined date 12. User-defined dates used for customized information about the account.
	UserDate12 string `json:"userDate12,omitempty"`

	// Format: YYYYMMDD. User defined date 13. User-defined dates used for customized information about the account.
	UserDate13 string `json:"userDate13,omitempty"`

	// Format: YYYYMMDD. User defined date 14. User-defined dates used for customized information about the account.
	UserDate14 string `json:"userDate14,omitempty"`

	// Format: YYYYMMDD. User defined date 2. User-defined dates used for customized information about the account.
	UserDate2 string `json:"userDate2,omitempty"`

	// Format: YYYYMMDD. User defined date 3. User-defined dates used for customized information about the account.
	UserDate3 string `json:"userDate3,omitempty"`

	// Format: YYYYMMDD. User defined date 4. User-defined dates used for customized information about the account.
	UserDate4 string `json:"userDate4,omitempty"`

	// Format: YYYYMMDD. User defined date 5. User-defined dates used for customized information about the account.
	UserDate5 string `json:"userDate5,omitempty"`

	// Format: YYYYMMDD. User defined date 6. User-defined dates used for customized information about the account.
	UserDate6 string `json:"userDate6,omitempty"`

	// Format: YYYYMMDD. User defined date 7. User-defined dates used for customized information about the account.
	UserDate7 string `json:"userDate7,omitempty"`

	// Format: YYYYMMDD. User defined date 8. User-defined dates used for customized information about the account.
	UserDate8 string `json:"userDate8,omitempty"`

	// Format: YYYYMMDD. User defined date 9. User-defined dates used for customized information about the account.
	UserDate9 string `json:"userDate9,omitempty"`
}

// Validate validates this account user fields update request2
func (m *AccountUserFieldsUpdateRequest2) Validate(formats strfmt.Registry) error {
	var res []error
	...
	if err := m.validateSuspenseStatus(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateSuspenseWaiverFlag(formats); err != nil {
		res = append(res, err)
	}
...
func (m *AccountUserFieldsUpdateRequest2) validateAcctNbr(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateApplUser2(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateApplUser3(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateCommon(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateForeignUseFlag(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateMiscUser1(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateMiscUser10(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateMiscUser11(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateMiscUser12(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateMiscUser2(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateMiscUser3(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateMiscUser4(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateMiscUser5(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateMiscUser6(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateMiscUser7(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateMiscUser8(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateMiscUser9(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateSuspenseStatus(formats strfmt.Registry) error {

	if swag.IsZero(m.SuspenseStatus) { // not required
		return nil
	}

	if err := validate.MinLength("suspenseStatus", "body", string(*m.SuspenseStatus), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("suspenseStatus", "body", string(*m.SuspenseStatus), 1); err != nil {
		return err
	}
...
func (m *AccountUserFieldsUpdateRequest2) validateSuspenseWaiverFlag(formats strfmt.Registry) error {

	if swag.IsZero(m.SuspenseWaiverFlag) { // not required
		return nil
	}

	if err := validate.MinLength("suspenseWaiverFlag", "body", string(*m.SuspenseWaiverFlag), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("suspenseWaiverFlag", "body", string(*m.SuspenseWaiverFlag), 1); err != nil {
		return err
	}

	if err := validate.Pattern("suspenseWaiverFlag", "body", string(*m.SuspenseWaiverFlag), `^[0-9]*$`); err != nil {
		return err
	}
...
func (m *AccountUserFieldsUpdateRequest2) validateUserAmt1(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserAmt10(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserAmt11(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserAmt12(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserAmt13(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserAmt14(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserAmt2(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserAmt3(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserAmt4(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserAmt5(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserAmt6(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserAmt7(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserAmt8(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserAmt9(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserCode1(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserCode10(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserCode11(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserCode12(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserCode13(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserCode14(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserCode2(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserCode3(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserCode4(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserCode5(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserCode6(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserCode7(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserCode8(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) validateUserCode9(formats strfmt.Registry) error {
...
func (m *AccountUserFieldsUpdateRequest2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AccountUserFieldsUpdateRequest2) UnmarshalBinary(b []byte) error {
	var res AccountUserFieldsUpdateRequest2
