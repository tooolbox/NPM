...
// AccountDetailInquiryResponse3 account detail inquiry response3
//
// swagger:model AccountDetailInquiryResponse3
type AccountDetailInquiryResponse3 struct {
	...
	//  Max length = 17, Amount last debited to the account.
	AmtLastDb string `json:"amtLastDb,omitempty"`

	//  Max length = 17, Amount Of Last Purchase: Amount of the last purchase made on the account. This amount is the total of all transactions that were made on the same day.
	AmtLastPurch string `json:"amtLastPurch,omitempty"`
	...
	AtmOtcQsiRtlAccum []*AtmOtcQsiRtlAccum3ForAccountDetailInquiry3 `json:"atmOtcQsiRtlAccum"`
	...
	//  Max length = 1, Auth EPP Opt Flag
	...
	// Format: YYYYMMDD. Card expiry date. Indicates the date on which the most recently issued card expires. This is returned if a card number is used for <em>acct</em> field in the request.
	...
	// Format: YYYYMMDD. Card fee date first purchase.
	...
	// Format: YYYYMMDD. Current Card Start Date: Date embossed on a magnetic-stripe card that indicates when the card becomes valid. This date is the first day of the month on which the card becomes valid.
	...
	// Format: YYYYMMDD. Date interest accrued through till
	DateAccrThru string `json:"dateAccrThru,omitempty"`

	// Format: YYYYMMDD. Date when ACH became effective
	...
	// Format: YYYYMMDD. Date Block Code 1.
	DateBlockCode1 string `json:"dateBlockCode1,omitempty"`

	// Format: YYYYMMDD. Date Block Code 2.
	...
	// Format: YYYYMMDD. Card expiry date. This will be returned for the active primary card on the account.
	...
	// Format: YYYYMMDD. Date account is charged-off.
	DateCgoff string `json:"dateCgoff,omitempty"`

	// Format: YYYYMMDD. Date account is closed.
	DateClosed string `json:"dateClosed,omitempty"`

	// Format: YYYYMMDD. Date account went into credit balance
	...
	// Format: YYYYMMDD. Date account was sent to collections
	DateIntoColl string `json:"dateIntoColl,omitempty"`

	// Format: YYYYMMDD. Date of last monetary activity.
	DateLastAct string `json:"dateLastAct,omitempty"`

	// Format: YYYYMMDD. Date of Last Credit
	DateLastCr string `json:"dateLastCr,omitempty"`

	// Format: YYYYMMDD. Date last credit limit changed
	DateLastCrlim string `json:"dateLastCrlim,omitempty"`

	// Format: YYYYMMDD. Date Last Cycle
	DateLastCycle string `json:"dateLastCycle,omitempty"`

	// Format: YYYYMMDD. Date of Last Debit
	DateLastDb string `json:"dateLastDb,omitempty"`

	// Format: YYYYMMDD. Date Last Delinquency: Date last time account was delinquent.
	DateLastDelq string `json:"dateLastDelq,omitempty"`

	// Format: YYYYMMDD. Date last expiry: Indicates the date on which the previously issued card expired. This will be returned for the active primary card on the account.
	...
	// Format: YYYYMMDD. Date Last Purchase: Date on which the last purchase was made on the account.
	DateLastPurch string `json:"dateLastPurch,omitempty"`

	// Format: YYYYMMDD. Date when last rate change occurred
	DateLastRateChg string `json:"dateLastRateChg,omitempty"`

	// Format: YYYYMMDD. Date the account was last reaged
	DateLastReage string `json:"dateLastReage,omitempty"`

	// Format: YYYYMMDD. Date Last Return: Date of last return that was made on  the account.
	DateLastReturn string `json:"dateLastReturn,omitempty"`

	// Format: YYYYMMDD. Date of last reversed payment.
	DateLastRevPmt string `json:"dateLastRevPmt,omitempty"`

	// Format: YYYYMMDD. Date of last check return
	DateLastRtnCheck string `json:"dateLastRtnCheck,omitempty"`

	// Format: YYYYMMDD. Date of last status change.
	...
	// Format: YYYYMMDD. Date Last updated for credit limit increase preference indicator
	DateLastUcliUpd string `json:"dateLastUcliUpd,omitempty"`

	// Format: YYYYMMDD. Date when late fee was charged
	...
	// Format: YYYYMMDD. Date next credit bureau
	DateNextCb string `json:"dateNextCb,omitempty"`

	// Format: YYYYMMDD. Date Next Payment
	...
	// Format: YYYYMMDD. Date when notification received
	...
	// Format: YYYYMMDD. Date account transferred
	...
	// Format: YYYYMMDD. DD payment change date
	...
	// Format: YYYYMMDD. Date projected DD last maintained
	...
	// Format: YYYYMMDD. Embosser Date Block: Date the block code was placed on the card (embosser).
	...
	// Format: YYYYMMDD. FAS warning code 1 set date
	FasWarnCode1Date string `json:"fasWarnCode1Date,omitempty"`

	// Warning Code Group Occurrence 7 Times. Occurrence length is 1 byte
	FasWarningCodes []*FasWarningCodes3ForAccountDetailInquiry3 `json:"fasWarningCodes"`
	...
	// Format: YYYYMMDD. TRIAD Credit Limit Offer Date: Date TRIAD made the Credit Limit offer.
	...
	// Format: YYYYMMDD. TRIAD Credit Limit Offer Expiry Date: Expiration date of the credit limit offer. TRIAD changes the status of the offer to expired after the offer has been expired.
	FiExpDtCrlimOffer string `json:"fiExpDtCrlimOffer,omitempty"`

	// Format: YYYYMMDD. End Date of new pricing actions returned for account.
	FiReprEndDate string `json:"fiReprEndDate,omitempty"`

	// 2 Occurrences of TRIAD score.
	FiScores []*FiScores3ForAccountDetailInquiry3 `json:"fiScores"`

	// 2 Occurrences of TRIAD score.
	FiScors []*FiScors3ForAccountDetailInquiry3 `json:"fiScors"`
	...
	//  Max length = 17, Fixed payment amount or percentage of the credit limit that CMS uses to calculate the payment amount if the PLAN PMT OVRD FLAG is F, X, P, A, B or C.
	...
	FsPgmBalX []*FsPgmBalX3ForAccountDetailInquiry3 `json:"fsPgmBalX"`

	//  Max length = 17, Grace CTD
	GraceCtd string `json:"graceCtd,omitempty"`

	// Format: YYYYMMDD. Interest grace expiry date
	GraceDayExpirDate string `json:"graceDayExpirDate,omitempty"`

	// Format: YYYYMMDD. Greatest card expiry date on the account. Recorded on the account across all cards belonging to the account.
	...
	Hist []*Hist3ForAccountDetailInquiry3 `json:"hist"`
	...
	// Format: YYYYMMDD. Date last cash advance date
	...
	// Format: YYYYMMDD. Last date to allow authorization on the old account
	...
	// Format: YYYYMMDD. Oldest card expiry date on the the account. Recorded on the account across all cards belonging to the account.
	...
	// Format: YYYYMMDD. Last offer outcome date
	...
	// Multi Scheme Card
	MsCard []*MsCard3ForAccountDetailInquiry3 `json:"msCard"`

	// Repeating group depends on maker or co-maker.
	NaData []*NaData3ForAccountDetailInquiry3 `json:"naData"`
	...
	// Format: YYYYMMDD. PCT Level Start Date: Date when PCT-LEVEL is effective. Temporary override at the Account level.
	...
	// Format: YYYYMMDD. Pending PCT ID effective date
	PendPctEffDate string `json:"pendPctEffDate,omitempty"`

	// Format: YYYYMMDD. Pending PCT ID end/expiry date
	...
	// Format: YYYYMMDD. Date of Previous Statement.
	...
	//  Max length = 2, Total Active Auth Epp
	TotActvAuthEppCtr string `json:"totActvAuthEppCtr,omitempty"`
	...
	// Format: YYYYMMDD. User-defined date used for customized information about the account.
	UserDate1 string `json:"userDate1,omitempty"`

	// Format: YYYYMMDD. User defined date 10.
	UserDate10 string `json:"userDate10,omitempty"`

	// Format: YYYYMMDD. User defined date 11.
	UserDate11 string `json:"userDate11,omitempty"`

	// Format: YYYYMMDD. User defined date 12.
	UserDate12 string `json:"userDate12,omitempty"`

	// Format: YYYYMMDD. User defined date 13.
	UserDate13 string `json:"userDate13,omitempty"`

	// Format: YYYYMMDD. User defined date 14.
	UserDate14 string `json:"userDate14,omitempty"`

	// Format: YYYYMMDD. User defined date 2.
	UserDate2 string `json:"userDate2,omitempty"`

	// Format: YYYYMMDD. User defined date 3.
	UserDate3 string `json:"userDate3,omitempty"`

	// Format: YYYYMMDD. User defined date 4.
	UserDate4 string `json:"userDate4,omitempty"`

	// Format: YYYYMMDD. User defined date 5.
	UserDate5 string `json:"userDate5,omitempty"`

	// Format: YYYYMMDD. User defined date 6.
	UserDate6 string `json:"userDate6,omitempty"`

	// Format: YYYYMMDD. User defined date 7.
	UserDate7 string `json:"userDate7,omitempty"`

	// Format: YYYYMMDD. User defined date 8.
	UserDate8 string `json:"userDate8,omitempty"`

	// Format: YYYYMMDD. User defined date 9.
...
// Validate validates this account detail inquiry response3
func (m *AccountDetailInquiryResponse3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AccountDetailInquiryResponse3) validateAtmOtcQsiRtlAccum(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse3) validateCommon(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse3) validateFasWarningCodes(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse3) validateFiScores(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse3) validateFiScors(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse3) validateFsPgmBalX(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse3) validateHist(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse3) validateMsCard(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse3) validateNaData(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse3) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AccountDetailInquiryResponse3) UnmarshalBinary(b []byte) error {
	var res AccountDetailInquiryResponse3
