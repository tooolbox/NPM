...
// CardDataForCustomerAccountCardAdd1 card data for customer account card add1
//
// swagger:model CardDataForCustomerAccountCardAdd1
type CardDataForCustomerAccountCardAdd1 struct {
	...
	//  Max length = 19, DIGITAL CARD NBR
	...
	//  Max length = 19, VPAY CARD NBR
	VpayCardNbr string `json:"vpayCardNbr,omitempty"`
}

// Validate validates this card data for customer account card add1
func (m *CardDataForCustomerAccountCardAdd1) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *CardDataForCustomerAccountCardAdd1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CardDataForCustomerAccountCardAdd1) UnmarshalBinary(b []byte) error {
	var res CardDataForCustomerAccountCardAdd1
