...
// TransactionDetailInquiryResponse2 transaction detail inquiry response2
//
// swagger:model TransactionDetailInquiryResponse2
type TransactionDetailInquiryResponse2 struct {
	...
	// Format: YYYYMMDD. For internal use only (see above).
	...
	TxnData []*TxnData2ForTransactionDetailInquiry2 `json:"txnData"`
...
// Validate validates this transaction detail inquiry response2
func (m *TransactionDetailInquiryResponse2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TransactionDetailInquiryResponse2) validateCommon(formats strfmt.Registry) error {
...
func (m *TransactionDetailInquiryResponse2) validateTxnData(formats strfmt.Registry) error {
...
func (m *TransactionDetailInquiryResponse2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TransactionDetailInquiryResponse2) UnmarshalBinary(b []byte) error {
	var res TransactionDetailInquiryResponse2
