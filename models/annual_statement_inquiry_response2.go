...
// AnnualStatementInquiryResponse2 annual statement inquiry response2
//
// swagger:model AnnualStatementInquiryResponse2
type AnnualStatementInquiryResponse2 struct {
	...
	PlanTable []*PlanTable2ForAnnualStatementInquiry2 `json:"planTable"`

	//  Max length = 20, Short name: Short name of the accountholder.
	ShrtName string `json:"shrtName,omitempty"`

	// Format: YYYYMMDD. Annual statement period start date from ACCS summary record.
	...
	StmtData []*StmtData2ForAnnualStatementInquiry2 `json:"stmtData"`

	// Year-to-date Plan Table; 6 occurrences: (1) = Retail (2) = Cash (3) = Balance Transfer (4) = Access Check (5) = Loans (6) = Others
	YtdPlanTable []*YtdPlanTable2ForAnnualStatementInquiry2 `json:"ytdPlanTable"`

	// Year-to-date statement data; 2 occurrences: (1) = Total of Initial Transactions (2) = Total of Reversal Transactions
	YtdStmtData []*YtdStmtData2ForAnnualStatementInquiry2 `json:"ytdStmtData"`
}

// Validate validates this annual statement inquiry response2
func (m *AnnualStatementInquiryResponse2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AnnualStatementInquiryResponse2) validateCommon(formats strfmt.Registry) error {
...
func (m *AnnualStatementInquiryResponse2) validatePlanTable(formats strfmt.Registry) error {
...
func (m *AnnualStatementInquiryResponse2) validateStmtData(formats strfmt.Registry) error {
...
func (m *AnnualStatementInquiryResponse2) validateYtdPlanTable(formats strfmt.Registry) error {
...
func (m *AnnualStatementInquiryResponse2) validateYtdStmtData(formats strfmt.Registry) error {
...
func (m *AnnualStatementInquiryResponse2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AnnualStatementInquiryResponse2) UnmarshalBinary(b []byte) error {
	var res AnnualStatementInquiryResponse2
