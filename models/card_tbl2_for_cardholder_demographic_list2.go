...
// CardTbl2ForCardholderDemographicList2 card tbl2 for cardholder demographic list2
//
// swagger:model CardTbl2ForCardholderDemographicList2
type CardTbl2ForCardholderDemographicList2 struct {
...
// Validate validates this card tbl2 for cardholder demographic list2
func (m *CardTbl2ForCardholderDemographicList2) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *CardTbl2ForCardholderDemographicList2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CardTbl2ForCardholderDemographicList2) UnmarshalBinary(b []byte) error {
	var res CardTbl2ForCardholderDemographicList2
