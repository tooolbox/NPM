...
// RealTimePaymentWithMemoResponse2 real time payment with memo response2
//
// swagger:model RealTimePaymentWithMemoResponse2
type RealTimePaymentWithMemoResponse2 struct {
...
// Validate validates this real time payment with memo response2
func (m *RealTimePaymentWithMemoResponse2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RealTimePaymentWithMemoResponse2) validateCommon(formats strfmt.Registry) error {
...
func (m *RealTimePaymentWithMemoResponse2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RealTimePaymentWithMemoResponse2) UnmarshalBinary(b []byte) error {
	var res RealTimePaymentWithMemoResponse2
