...
// AccountDetailInquiryResponse account detail inquiry response
//
// swagger:model AccountDetailInquiryResponse
type AccountDetailInquiryResponse struct {
	...
	// ATM OTC QSI RTL ACCUM
	AtmOtcQsiRtlAccum []*AtmOtcQsiRtlAccumForAccountDetailInquiry1 `json:"atmOtcQsiRtlAccum"`
	...
	//  Max length = 7, Unique Card Number embossed on card plastic.
	...
	//  Max length = 19, Customer Correspondence Number: Number that identifies the Customer Name/Address record that contains the correspondence customer address for statements and other correspondence, which will be used instead of the Primary customer held on the Acount
	...
	//  Max length = 17, Current cash balance for this account.
	...
	// Format: YYYYMMDD. Card expiry date
	...
	FasWarningCodes []*FasWarningCodesForAccountDetailInquiry1 `json:"fasWarningCodes"`
	...
	FiScores []*FiScoresForAccountDetailInquiry1 `json:"fiScores"`

	// 2 Occurrences of TRIAD score.
	FiScors []*FiScorsForAccountDetailInquiry1 `json:"fiScors"`
	...
	FsPgmBalX []*FsPgmBalXForAccountDetailInquiry1 `json:"fsPgmBalX"`

	// Format: YYYYMMDD. Interest grace expiry date
	GraceDayExpirDate string `json:"graceDayExpirDate,omitempty"`

	// Format: YYYYMMDD. Greatest card expiry date on the account
	...
	Hist []*HistForAccountDetailInquiry1 `json:"hist"`
	...
	// Format: YYYYMMDD. Oldest card expiry date on the the account
	...
	// Multi Scheme Card
	MsCard []*MsCardForAccountDetailInquiry1 `json:"msCard"`

	//  Max length = 2, Repeating group depends on maker or co-maker.
	NaData string `json:"naData,omitempty"`
	...
	//  Max length = 17, Amount of cash outstanding authorizations.
	...
	//  Max length = 1, Waive Late Charge Flag: Flag that indicates whether to waive late charges for the account.  Values are:  0 - Do not waive late charges (Default)  1 - Permanently Waive late charges.  4 - Waive late charges for 1 cycle, 5 - Waive late charges for 2 cycles, 6 - Waive late charges for 3 cycles, 9 - Waive late charges for this cycle
...
// Validate validates this account detail inquiry response
func (m *AccountDetailInquiryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AccountDetailInquiryResponse) validateAtmOtcQsiRtlAccum(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse) validateCommon(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse) validateFasWarningCodes(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse) validateFiScores(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse) validateFiScors(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse) validateFsPgmBalX(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse) validateHist(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse) validateMsCard(formats strfmt.Registry) error {
...
func (m *AccountDetailInquiryResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AccountDetailInquiryResponse) UnmarshalBinary(b []byte) error {
	var res AccountDetailInquiryResponse
