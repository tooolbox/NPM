...
// CustomerDataUpdateRequest2 customer data update request2
//
// swagger:model CustomerDataUpdateRequest2
type CustomerDataUpdateRequest2 struct {

	//  Max length = 5, Block: Specific field for Block section when using Spanish address. When this field, a2block, is populated make sure the field address2 is not populated. Also all the three a2 fields (a2Block, a2Portal and a2Stairs) need to be populated together for the update to work. <p> Usage of this field depends on custFormat field. Please refer to documentation of custFormat field for details.
	// Max Length: 5
	// Min Length: 0
	A2Block *string `json:"a2Block,omitempty"`

	//  Max length = 5, Portal: Specific field for Portal section when using Spanish address. When this field, a2portal, is populated make sure the field address2 is not populated. Also all the three a2 fields (a2Block, a2Portal and a2Stairs) need to be populated together for the update to work. <p> Usage of this field depends on custFormat field. Please refer to documentation of custFormat field for details.
	// Max Length: 5
	// Min Length: 0
	A2Portal *string `json:"a2Portal,omitempty"`

	//  Max length = 5, Stairs: Specific field for stair section when using Spanish address. When this field, a2stair, is populated make sure the field address2 is not populated. Also all the three a2 fields (a2Block, a2Portal and a2Stairs) need to be populated together for the update to work. <p> Usage of this field depends on custFormat field. Please refer to documentation of custFormat field for details.
	// Max Length: 5
	// Min Length: 0
	A2Stairs *string `json:"a2Stairs,omitempty"`

	//  Max length = 5, Door: Specific field for door section when using Spanish address. When this field, a3door, is populated make sure the field address3 is not populated. Also both the a3 fields (a3Floor and a3Door) need to be populated together for the update to work. <p> Usage of this field depends on custFormat field. Please refer to documentation of custFormat field for details.
	// Max Length: 5
	// Min Length: 0
	A3Door *string `json:"a3Door,omitempty"`

	//  Max length = 5, Floor: Specific field for floor section when using Spanish address. When this field, a3floor, is populated make sure the field address3 is not populated. Also both the a3 fields (a3Floor and a3Door) need to be populated together for the update to work. <p> Usage of this field depends on custFormat field. Please refer to documentation of custFormat field for details.
	// Max Length: 5
	// Min Length: 0
	...
	//  Max length = 40, Address Line 2 of the customer as defined on the Customer Name/Address record. When this field, address2, is populated make sure the fields a2block, a2portal and a2stairs are not populated. <p> Usage of this field depends on custFormat field. Please refer to documentation of custFormat field for details.
	// Max Length: 40
	// Min Length: 0
	Address2 *string `json:"address2,omitempty"`

	//  Max length = 40, Address Line 3 of the customer as defined on the Customer Name/Address record. When this field, address3, is populated make sure the fields a3floor and a3door are not populated. Also both the a3 fields need to be populated together for the update to work. <p> Usage of this field depends on custFormat field. Please refer to documentation of custFormat field for details.
	// Max Length: 40
	// Min Length: 0
	Address3 *string `json:"address3,omitempty"`

	//  Max length = 1, Affordability Data Indicator: This indicator defines whether to update or not the owner/co-owner user demographics data elements stored in the customer record.<p> Values are: <UL><LI><EM>0 or Space -</EM> Do Not Update the Owner/Co-Owner User Data (default) </LI><LI><EM>1 -</EM> Update Owner User Data </LI><LI><EM>2 - </EM>Update Co-Owner User Data</LI></UL> <p> At least one of affordDataInd or userDataInd must be '1' in a request.
	// Required: true
	// Max Length: 1
	// Min Length: 0
	...
	//  Max length = 1, Customer Format Indicator. This is used to update address2 and address3 fields as single 40 byte fields or separate fields split as described below. The custFormat of 1 is mainly used in Spain. Valid values are:<UL><LI><EM>0 - </EM> Not Formatted <p> Customer Address details present in address2 and address3 fields are updated as they are. When custFormat is 0, the split fields a2Block, a2Portal and a2Stairs are not to be populated for address2 and a3Floor and a3Door are not to be populated for address3.</LI><LI><EM> 1 - </EM> Formatted Address Lines 2 and 3. <p> When custFormat is 1, then address2 and address3 are not to be populated. Moreover, all three address2 fields (a2Stairs, a2Portal, a2Block) to be provided for a successful update. Similarly Both address3 fields (a3Door and a3Floor)</LI></UL>
	// Required: true
	// Max Length: 1
	// Min Length: 0
	...
	//  Max length = 20, Employer City.
	// Max Length: 20
	// Min Length: 0
	EmpCity *string `json:"empCity,omitempty"`

	//  Max length = 3, Employer Country Code.
	// Max Length: 3
	// Min Length: 0
	EmpCntryCd *string `json:"empCntryCd,omitempty"`
	...
	//  Max length = 10, Employer Postal Code.
	// Max Length: 10
	// Min Length: 0
	EmpPstlCd *string `json:"empPstlCd,omitempty"`

	//  Max length = 20, Employer State.
	// Max Length: 20
	// Min Length: 0
	EmpState *string `json:"empState,omitempty"`
	...
	// Max Length: 40
	// Min Length: 0
	EmployerAddr3 *string `json:"employerAddr3,omitempty"`
	...
	//  Max length = 1, Mail Preferences. Valid values are: <UL><LI> <EM>0 -</EM> Home Address</LI> <LI><EM>1 - </EM> Office Address</LI> <LI><EM>2 - </EM> Permanent Resident Address</LI></UL>
	// Max Length: 1
	// Min Length: 0
	...
	//  Max length = 1, User Data Indicator: This indicator defines whether to update or not the owner/co-owner user data elements stored in the customer record. <p>Values are:</ul><LI><em>0 or space - </em>Do Not Update the Owner/Co-Owner User Data (default) </LI><LI><EM>1 - </EM>Update Owner User Data </LI><LI><EM>2 - </EM>Update Co-Owner User Data </LI></UL><p> At least one of affordDataInd or userDataInd must be '1' in a request.
	// Required: true
	// Max Length: 1
	// Min Length: 0
...
// Validate validates this customer data update request2
func (m *CustomerDataUpdateRequest2) Validate(formats strfmt.Registry) error {
	var res []error
	...
	if err := m.validateEmpCity(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateEmpCntryCd(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateEmpPstlCd(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateEmpState(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateEmployerAddr3(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateMailPref(formats); err != nil {
		res = append(res, err)
	}
...
func (m *CustomerDataUpdateRequest2) validateA2Block(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateA2Portal(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateA2Stairs(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateA3Door(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateA3Floor(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateAcctNbr(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateAddr1(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateAddr4(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateAddress2(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("address2", "body", string(*m.Address2), 40); err != nil {
		return err
	}
...
func (m *CustomerDataUpdateRequest2) validateAddress3(formats strfmt.Registry) error {

	if swag.IsZero(m.Address3) { // not required
		return nil
	}

	if err := validate.MinLength("address3", "body", string(*m.Address3), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("address3", "body", string(*m.Address3), 40); err != nil {
		return err
	}
...
func (m *CustomerDataUpdateRequest2) validateAffordDataInd(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateAffordEmploymentStatus(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateAffordMinCardRepayments(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateAffordMnthLoanRepayments(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateAffordMnthMortgagePmt(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateAffordMnthSpending(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateAffordNetMnthIncome(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateAffordNumDependents(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateAffordPurpose(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateAffordRequestedCrlim(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateAffordSustainability(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateCarrierRoute12(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateCarrierRoute34(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateCity(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateCommon(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateContactInd(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateCountryCode(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateCounty(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateCustFormat(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateDelivPointSuffix(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateDemo1(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateDemo2(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateDemo3(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateDlCntry(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateDlNbr(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateDlState(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateEmail(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateEmailFlag(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateEmpCity(formats strfmt.Registry) error {

	if swag.IsZero(m.EmpCity) { // not required
		return nil
	}

	if err := validate.MinLength("empCity", "body", string(*m.EmpCity), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("empCity", "body", string(*m.EmpCity), 20); err != nil {
		return err
	}
...
func (m *CustomerDataUpdateRequest2) validateEmpCntryCd(formats strfmt.Registry) error {

	if swag.IsZero(m.EmpCntryCd) { // not required
		return nil
	}

	if err := validate.MinLength("empCntryCd", "body", string(*m.EmpCntryCd), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("empCntryCd", "body", string(*m.EmpCntryCd), 3); err != nil {
		return err
	}
...
func (m *CustomerDataUpdateRequest2) validateEmpPhoneExtn(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateEmpPstlCd(formats strfmt.Registry) error {

	if swag.IsZero(m.EmpPstlCd) { // not required
		return nil
	}

	if err := validate.MinLength("empPstlCd", "body", string(*m.EmpPstlCd), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("empPstlCd", "body", string(*m.EmpPstlCd), 10); err != nil {
		return err
	}
...
func (m *CustomerDataUpdateRequest2) validateEmpState(formats strfmt.Registry) error {

	if swag.IsZero(m.EmpState) { // not required
		return nil
	}

	if err := validate.MinLength("empState", "body", string(*m.EmpState), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("empState", "body", string(*m.EmpState), 20); err != nil {
		return err
	}
...
func (m *CustomerDataUpdateRequest2) validateEmpStatus(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateEmpWorkPhone(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateEmpWorkPhoneFlag(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateEmployer(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateEmployerAddr1(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateEmployerAddr2(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateEmployerAddr3(formats strfmt.Registry) error {

	if swag.IsZero(m.EmployerAddr3) { // not required
		return nil
	}

	if err := validate.MinLength("employerAddr3", "body", string(*m.EmployerAddr3), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("employerAddr3", "body", string(*m.EmployerAddr3), 40); err != nil {
		return err
	}
...
func (m *CustomerDataUpdateRequest2) validateFaxPhone(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateFaxPhoneFlag(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateFirstName(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateForeignCountryInd1099c(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateForeignUseFlag(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateGenderCode(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateHomePhoneFlag(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateHomePhoneNbr(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateHouseName(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateHouseNumber(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateIDFraud(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateLanguageIndic(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateLastName(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateLtrNotifyMod(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateLtrPrefInd(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateMailPref(formats strfmt.Registry) error {

	if swag.IsZero(m.MailPref) { // not required
		return nil
	}

	if err := validate.MinLength("mailPref", "body", string(*m.MailPref), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("mailPref", "body", string(*m.MailPref), 1); err != nil {
		return err
	}
...
func (m *CustomerDataUpdateRequest2) validateMailingList(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateMaritalStatus(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateMemo1(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateMemo2(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateMemorableWord(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateMemorableWordReminder(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateMiddleName(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateMobilePhone(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateMobilePhoneFlag(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateNameLine1(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateNameLine1Typ(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateNameLine2(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateNameLine2Typ(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateNameLine3(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateNameLine3Typ(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateNationality(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateNumberType(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validatePosition(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validatePostalCode(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateRelativeName(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateResidenceCode(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateRoadName(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateSicCode(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateSmsFlag(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateSpclAddrInd(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateState(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateStatus(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateStmtMsgIndic(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateStmtNotifyInd(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateStmtNotifyMod(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateSuffix(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateTaxIDNbr(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateTaxIDTyp(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateTitle(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUniqueID(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser1(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser10(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser11(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser12(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser13(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser14(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser15(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser2(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser3(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser4(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser5(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser6(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser7(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser8(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUser9(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateUserDataInd(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateVacAddr3(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateVacCntryCd(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateVacPhoneNbr(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateVipStatus(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) validateW9DateFiled1099c(formats strfmt.Registry) error {
...
func (m *CustomerDataUpdateRequest2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CustomerDataUpdateRequest2) UnmarshalBinary(b []byte) error {
	var res CustomerDataUpdateRequest2
