...
// CardholderDemographicListRequest cardholder demographic list request
//
// swagger:model CardholderDemographicListRequest
type CardholderDemographicListRequest struct {
...
// Validate validates this cardholder demographic list request
func (m *CardholderDemographicListRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CardholderDemographicListRequest) validateAccountDemographicsSw(formats strfmt.Registry) error {
...
func (m *CardholderDemographicListRequest) validateAcct(formats strfmt.Registry) error {
...
func (m *CardholderDemographicListRequest) validateAssocDemographicsSw(formats strfmt.Registry) error {
...
func (m *CardholderDemographicListRequest) validateCardDemographicsSw(formats strfmt.Registry) error {
...
func (m *CardholderDemographicListRequest) validateCardNbr(formats strfmt.Registry) error {
...
func (m *CardholderDemographicListRequest) validateCardOrg(formats strfmt.Registry) error {
...
func (m *CardholderDemographicListRequest) validateCardSeq(formats strfmt.Registry) error {
...
func (m *CardholderDemographicListRequest) validateCommon(formats strfmt.Registry) error {
...
func (m *CardholderDemographicListRequest) validateNbrOfRecsReq(formats strfmt.Registry) error {
...
func (m *CardholderDemographicListRequest) validatePriorMailSw(formats strfmt.Registry) error {
...
func (m *CardholderDemographicListRequest) validateSvcFuncCd(formats strfmt.Registry) error {
...
func (m *CardholderDemographicListRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CardholderDemographicListRequest) UnmarshalBinary(b []byte) error {
	var res CardholderDemographicListRequest
