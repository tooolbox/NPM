...
// CreditLimitDriverInquiryRequest credit limit driver inquiry request
//
// swagger:model CreditLimitDriverInquiryRequest
type CreditLimitDriverInquiryRequest struct {
...
// Validate validates this credit limit driver inquiry request
func (m *CreditLimitDriverInquiryRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreditLimitDriverInquiryRequest) validateAcctNbr(formats strfmt.Registry) error {
...
func (m *CreditLimitDriverInquiryRequest) validateAction(formats strfmt.Registry) error {
...
func (m *CreditLimitDriverInquiryRequest) validateAffordSkipFlg(formats strfmt.Registry) error {
...
func (m *CreditLimitDriverInquiryRequest) validateChecksum(formats strfmt.Registry) error {
...
func (m *CreditLimitDriverInquiryRequest) validateCommon(formats strfmt.Registry) error {
...
func (m *CreditLimitDriverInquiryRequest) validateCrlimReq(formats strfmt.Registry) error {
...
func (m *CreditLimitDriverInquiryRequest) validateCrlimTriad(formats strfmt.Registry) error {
...
func (m *CreditLimitDriverInquiryRequest) validateForeignUse(formats strfmt.Registry) error {
...
func (m *CreditLimitDriverInquiryRequest) validateOverrideReason(formats strfmt.Registry) error {
...
func (m *CreditLimitDriverInquiryRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreditLimitDriverInquiryRequest) UnmarshalBinary(b []byte) error {
	var res CreditLimitDriverInquiryRequest
