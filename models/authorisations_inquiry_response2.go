...
// AuthorisationsInquiryResponse2 authorisations inquiry response2
//
// swagger:model AuthorisationsInquiryResponse2
type AuthorisationsInquiryResponse2 struct {
	...
	// AUTHS TABLE
	AuthsTable []*AuthsTable2ForAuthorisationsInquiry2 `json:"authsTable"`
...
// Validate validates this authorisations inquiry response2
func (m *AuthorisationsInquiryResponse2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AuthorisationsInquiryResponse2) validateAuthsTable(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryResponse2) validateCommon(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryResponse2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AuthorisationsInquiryResponse2) UnmarshalBinary(b []byte) error {
	var res AuthorisationsInquiryResponse2
