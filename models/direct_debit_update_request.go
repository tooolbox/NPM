...
// DirectDebitUpdateRequest direct debit update request
//
// swagger:model DirectDebitUpdateRequest
type DirectDebitUpdateRequest struct {
	...
	// Format: YYYYDDD. Customer-nominated payment date. Field accepts julian date format.
	// Required: true
	// Max Length: 7
	// Min Length: 0
	// Pattern: ^[0-9]*$
	...
	// Format: YYYYDDD. Direct debit payment change date <Date will be accepted as Gregorian date-CCYYMMDD format>
	// Max Length: 7
	// Min Length: 0
	// Pattern: ^[0-9]*$
...
// Validate validates this direct debit update request
func (m *DirectDebitUpdateRequest) Validate(formats strfmt.Registry) error {
	var res []error
	...
	if err := m.validateAchPmtExprDate(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateDdPmtChangeDate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *DirectDebitUpdateRequest) validateAcctNbr(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateAchAmt(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateAchAmtPct(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateAchPmtExprDate(formats strfmt.Registry) error {

	if swag.IsZero(m.AchPmtExprDate) { // not required
		return nil
	}

	if err := validate.MinLength("achPmtExprDate", "body", string(*m.AchPmtExprDate), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("achPmtExprDate", "body", string(*m.AchPmtExprDate), 7); err != nil {
		return err
	}

	if err := validate.Pattern("achPmtExprDate", "body", string(*m.AchPmtExprDate), `^[0-9]*$`); err != nil {
		return err
	}
...
func (m *DirectDebitUpdateRequest) validateAchStartDate(formats strfmt.Registry) error {

	if err := validate.Required("achStartDate", "body", m.AchStartDate); err != nil {
		return err
	}

	if err := validate.MinLength("achStartDate", "body", string(*m.AchStartDate), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("achStartDate", "body", string(*m.AchStartDate), 7); err != nil {
		return err
	}

	if err := validate.Pattern("achStartDate", "body", string(*m.AchStartDate), `^[0-9]*$`); err != nil {
		return err
	}
...
func (m *DirectDebitUpdateRequest) validateCommon(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateDdAchReqDay(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateDdBic(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateDdCancel(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateDdCreditBal(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateDdDailyFreq(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateDdDaysFctn(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateDdDaysNbr(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateDdIban(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateDdInterimPmts(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateDdMandateStatus(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateDdNotifyCntl(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateDdPmtChangeDate(formats strfmt.Registry) error {

	if swag.IsZero(m.DdPmtChangeDate) { // not required
		return nil
	}

	if err := validate.MinLength("ddPmtChangeDate", "body", string(*m.DdPmtChangeDate), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("ddPmtChangeDate", "body", string(*m.DdPmtChangeDate), 7); err != nil {
		return err
	}

	if err := validate.Pattern("ddPmtChangeDate", "body", string(*m.DdPmtChangeDate), `^[0-9]*$`); err != nil {
		return err
	}
...
func (m *DirectDebitUpdateRequest) validateDdPmtRevCntr(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateDdSuspend(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateDdSuspendBypass(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateForeignUse(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateNomAchPct(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validatePayRemitMethod(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validatePmtAch(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validatePmtAchDbNbr(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validatePmtAchDbType(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validatePmtAchRtNbr(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) validateProjAchPmt(formats strfmt.Registry) error {
...
func (m *DirectDebitUpdateRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DirectDebitUpdateRequest) UnmarshalBinary(b []byte) error {
	var res DirectDebitUpdateRequest
