...
// NaData3ForAccountDetailInquiry3 na data3 for account detail inquiry3
//
// swagger:model NaData3ForAccountDetailInquiry3
type NaData3ForAccountDetailInquiry3 struct {
...
// Validate validates this na data3 for account detail inquiry3
func (m *NaData3ForAccountDetailInquiry3) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *NaData3ForAccountDetailInquiry3) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NaData3ForAccountDetailInquiry3) UnmarshalBinary(b []byte) error {
	var res NaData3ForAccountDetailInquiry3
