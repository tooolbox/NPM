...
// AuthorisationsInquiryRequest authorisations inquiry request
//
// swagger:model AuthorisationsInquiryRequest
type AuthorisationsInquiryRequest struct {
...
// Validate validates this authorisations inquiry request
func (m *AuthorisationsInquiryRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AuthorisationsInquiryRequest) validateAccountLogExt(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateAccountRba(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateAcct(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateActionFilter(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateAuthDetailFilter(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateCommon(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateEndTime(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateForeignUse(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateMerNbr(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateNbrOfRecsReq(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateStartTime(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateSvcFuncCode(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateTermid(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateTime(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateTxnAmt(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) validateTxnRecType(formats strfmt.Registry) error {
...
func (m *AuthorisationsInquiryRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AuthorisationsInquiryRequest) UnmarshalBinary(b []byte) error {
	var res AuthorisationsInquiryRequest
