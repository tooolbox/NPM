...
// EmbosserUpdateResponse embosser update response
//
// swagger:model EmbosserUpdateResponse
type EmbosserUpdateResponse struct {
...
// Validate validates this embosser update response
func (m *EmbosserUpdateResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EmbosserUpdateResponse) validateCommon(formats strfmt.Registry) error {
...
func (m *EmbosserUpdateResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *EmbosserUpdateResponse) UnmarshalBinary(b []byte) error {
	var res EmbosserUpdateResponse
