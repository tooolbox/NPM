...
// StmtData2ForAnnualStatementInquiry2 stmt data2 for annual statement inquiry2
//
// swagger:model StmtData2ForAnnualStatementInquiry2
type StmtData2ForAnnualStatementInquiry2 struct {
...
// Validate validates this stmt data2 for annual statement inquiry2
func (m *StmtData2ForAnnualStatementInquiry2) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StmtData2ForAnnualStatementInquiry2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StmtData2ForAnnualStatementInquiry2) UnmarshalBinary(b []byte) error {
	var res StmtData2ForAnnualStatementInquiry2
