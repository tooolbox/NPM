...
// EmbosserInquiryRequest embosser inquiry request
//
// swagger:model EmbosserInquiryRequest
type EmbosserInquiryRequest struct {
...
// Validate validates this embosser inquiry request
func (m *EmbosserInquiryRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EmbosserInquiryRequest) validateAccount(formats strfmt.Registry) error {
...
func (m *EmbosserInquiryRequest) validateCommon(formats strfmt.Registry) error {
...
func (m *EmbosserInquiryRequest) validateDualInd(formats strfmt.Registry) error {
...
func (m *EmbosserInquiryRequest) validateRecseq(formats strfmt.Registry) error {
...
func (m *EmbosserInquiryRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *EmbosserInquiryRequest) UnmarshalBinary(b []byte) error {
	var res EmbosserInquiryRequest
