...
// TransactionInquiryResponse2 transaction inquiry response2
//
// swagger:model TransactionInquiryResponse2
type TransactionInquiryResponse2 struct {
	...
	// Format: YYYYDDD. To support paging logic. Next Statement date forward key
	...
	// TRANSACTION DATA X
	TransactionDataX []*TransactionDataX2ForTransactionInquiry2 `json:"transactionDataX"`
...
// Validate validates this transaction inquiry response2
func (m *TransactionInquiryResponse2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TransactionInquiryResponse2) validateCommon(formats strfmt.Registry) error {
...
func (m *TransactionInquiryResponse2) validateTransactionDataX(formats strfmt.Registry) error {
...
func (m *TransactionInquiryResponse2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TransactionInquiryResponse2) UnmarshalBinary(b []byte) error {
	var res TransactionInquiryResponse2
