...
// CardInquiryResponse card inquiry response
//
// swagger:model CardInquiryResponse
type CardInquiryResponse struct {
	...
	//  Max length = 17, Additional total transaction amount
	...
	// Format: YYYYMMDD. Date on which the card is activated.
	...
	// CARD INFO
	CardInfo []*CardInfoForCardInquiry1 `json:"cardInfo"`
	...
	//  Max length = 10, Corp Id Number
	CorpIDNbr string `json:"corpIdNbr,omitempty"`

	// Format: YYYYMMDD. Date embossed on a card that indicates when the card becomes valid. This date is the first day of the month on which the card becomes valid.
	...
	// Format: YYYYMMDD. Current Card Mailer Date: Date the current card was mailed to the cardholder.
	...
	//  Max length = 19, Cardholder Customer Number
	EdCustNbr string `json:"edCustNbr,omitempty"`
	...
	// Format: YYYYMMDD. Date fraudMonitorFlag was Last Maintained
	...
	// Format: YYYYMMDD. Fraud Monitor Expiry Date
	FraudMonitorExpiryDate string `json:"fraudMonitorExpiryDate,omitempty"`

	//  Max length = 2, Fraud Monitor Flag
	...
	// Format: YYYYMMDD. Last pin ATM change date
	LastPinChangeAtmDate string `json:"lastPinChangeAtmDate,omitempty"`

	//  Max length = 7, Last pin ATM change time
	LastPinChangeAtmTime string `json:"lastPinChangeAtmTime,omitempty"`

	// Format: YYYYMMDD. Last pin WEB change date
	LastPinChangeWebDate string `json:"lastPinChangeWebDate,omitempty"`

	//  Max length = 7, Last pin WEB change time
	LastPinChangeWebTime string `json:"lastPinChangeWebTime,omitempty"`

	// Format: YYYYMMDD. Last pin counter reset date
	LastPinCounterResetDate string `json:"lastPinCounterResetDate,omitempty"`

	//  Max length = 7, Last pin counter reset time
	LastPinCounterResetTime string `json:"lastPinCounterResetTime,omitempty"`
	...
	PinChangeDate string `json:"pinChangeDate,omitempty"`
	...
	//  Max length = 1, Prepaid Card Action
	PrepaidCardAction string `json:"prepaidCardAction,omitempty"`

	// Format: YYYYMMDD. Prepaid Card Expiry Date
	PrepaidCardExpiryDate string `json:"prepaidCardExpiryDate,omitempty"`

	//  Max length = 19, Prepaid Card Number
	PrepaidCardNbr string `json:"prepaidCardNbr,omitempty"`

	//  Max length = 1, Prepaid Card Status
	PrepaidCardStatus string `json:"prepaidCardStatus,omitempty"`
	...
	SpndLmtsStats []*SpndLmtsStatsForCardInquiry1 `json:"spndLmtsStats"`
...
// Validate validates this card inquiry response
func (m *CardInquiryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CardInquiryResponse) validateCardInfo(formats strfmt.Registry) error {
...
func (m *CardInquiryResponse) validateCommon(formats strfmt.Registry) error {
...
func (m *CardInquiryResponse) validateSpndLmtsStats(formats strfmt.Registry) error {
...
func (m *CardInquiryResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CardInquiryResponse) UnmarshalBinary(b []byte) error {
	var res CardInquiryResponse
