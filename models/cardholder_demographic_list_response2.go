...
// CardholderDemographicListResponse2 cardholder demographic list response2
//
// swagger:model CardholderDemographicListResponse2
type CardholderDemographicListResponse2 struct {
	...
	CardTbl []*CardTbl2ForCardholderDemographicList2 `json:"cardTbl"`
...
// Validate validates this cardholder demographic list response2
func (m *CardholderDemographicListResponse2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CardholderDemographicListResponse2) validateCardTbl(formats strfmt.Registry) error {
...
func (m *CardholderDemographicListResponse2) validateCommon(formats strfmt.Registry) error {
...
func (m *CardholderDemographicListResponse2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CardholderDemographicListResponse2) UnmarshalBinary(b []byte) error {
	var res CardholderDemographicListResponse2
