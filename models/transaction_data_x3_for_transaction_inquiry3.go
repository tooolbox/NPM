...
// TransactionDataX3ForTransactionInquiry3 transaction data x3 for transaction inquiry3
//
// swagger:model TransactionDataX3ForTransactionInquiry3
type TransactionDataX3ForTransactionInquiry3 struct {
	...
	// Format: YYYYMMDD. Batch date of the transaction.
	...
	// Format: YYYYMMDD. Plan Open Date: Date plan segment was opened.
	...
	// Format: YYYYMMDD. Posting date of the transaction.
...
// Validate validates this transaction data x3 for transaction inquiry3
func (m *TransactionDataX3ForTransactionInquiry3) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *TransactionDataX3ForTransactionInquiry3) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TransactionDataX3ForTransactionInquiry3) UnmarshalBinary(b []byte) error {
	var res TransactionDataX3ForTransactionInquiry3
