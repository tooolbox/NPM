...
// RealTimePaymentwithMemoRequest real time paymentwith memo request
//
// swagger:model RealTimePaymentwithMemoRequest
type RealTimePaymentwithMemoRequest struct {
...
// Validate validates this real time paymentwith memo request
func (m *RealTimePaymentwithMemoRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RealTimePaymentwithMemoRequest) validateAcctNbr(formats strfmt.Registry) error {
...
func (m *RealTimePaymentwithMemoRequest) validateAcctOrg(formats strfmt.Registry) error {
...
func (m *RealTimePaymentwithMemoRequest) validateAsmOrg(formats strfmt.Registry) error {
...
func (m *RealTimePaymentwithMemoRequest) validateAsmRep(formats strfmt.Registry) error {
...
func (m *RealTimePaymentwithMemoRequest) validateAuthCode(formats strfmt.Registry) error {
...
func (m *RealTimePaymentwithMemoRequest) validateCommon(formats strfmt.Registry) error {
...
func (m *RealTimePaymentwithMemoRequest) validateCurrCode(formats strfmt.Registry) error {
...
func (m *RealTimePaymentwithMemoRequest) validateDualInd(formats strfmt.Registry) error {
...
func (m *RealTimePaymentwithMemoRequest) validatePymtRefNbr(formats strfmt.Registry) error {
...
func (m *RealTimePaymentwithMemoRequest) validateSvcType(formats strfmt.Registry) error {
...
func (m *RealTimePaymentwithMemoRequest) validateTxnAmount(formats strfmt.Registry) error {
...
func (m *RealTimePaymentwithMemoRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RealTimePaymentwithMemoRequest) UnmarshalBinary(b []byte) error {
	var res RealTimePaymentwithMemoRequest
