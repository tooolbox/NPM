...
// CardInfoForCardInquiry1 card info for card inquiry1
//
// swagger:model CardInfoForCardInquiry1
type CardInfoForCardInquiry1 struct {
...
// Validate validates this card info for card inquiry1
func (m *CardInfoForCardInquiry1) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *CardInfoForCardInquiry1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CardInfoForCardInquiry1) UnmarshalBinary(b []byte) error {
	var res CardInfoForCardInquiry1
