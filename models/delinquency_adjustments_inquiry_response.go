...
// DelinquencyAdjustmentsInquiryResponse delinquency adjustments inquiry response
//
// swagger:model DelinquencyAdjustmentsInquiryResponse
type DelinquencyAdjustmentsInquiryResponse struct {
	...
	// Format: YYYYDDD. Last re-aged date.
	Date1 string `json:"date1,omitempty"`

	// Format: YYYYDDD. 2nd Last re-aged date.
	Date2 string `json:"date2,omitempty"`

	// Format: YYYYDDD. 3rd Last re-aged date.
	...
	PlanData []*PlanDataForDelinquencyAdjustmentsInquiry1 `json:"planData"`
...
// Validate validates this delinquency adjustments inquiry response
func (m *DelinquencyAdjustmentsInquiryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DelinquencyAdjustmentsInquiryResponse) validateCommon(formats strfmt.Registry) error {
...
func (m *DelinquencyAdjustmentsInquiryResponse) validatePlanData(formats strfmt.Registry) error {
...
func (m *DelinquencyAdjustmentsInquiryResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DelinquencyAdjustmentsInquiryResponse) UnmarshalBinary(b []byte) error {
	var res DelinquencyAdjustmentsInquiryResponse
