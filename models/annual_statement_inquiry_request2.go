...
// AnnualStatementInquiryRequest2 annual statement inquiry request2
//
// swagger:model AnnualStatementInquiryRequest2
type AnnualStatementInquiryRequest2 struct {
...
// Validate validates this annual statement inquiry request2
func (m *AnnualStatementInquiryRequest2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AnnualStatementInquiryRequest2) validateAccount(formats strfmt.Registry) error {
...
func (m *AnnualStatementInquiryRequest2) validateCommon(formats strfmt.Registry) error {
...
func (m *AnnualStatementInquiryRequest2) validateForeignUse(formats strfmt.Registry) error {
...
func (m *AnnualStatementInquiryRequest2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AnnualStatementInquiryRequest2) UnmarshalBinary(b []byte) error {
	var res AnnualStatementInquiryRequest2
