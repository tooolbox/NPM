...
// MsCardLogoTableForCustomerAccountCardAdd1 ms card logo table for customer account card add1
//
// swagger:model MsCardLogoTableForCustomerAccountCardAdd1
type MsCardLogoTableForCustomerAccountCardAdd1 struct {
	...
	//  Max length = 5, Field that defines the cardholder's affiliation or affinity group. The values are user-defined. If EMBLEM ID is not provided it will be defaulted from the Card Logo setting
	// Max Length: 5
	// Min Length: 0
	// Pattern: ^[0-9]*$
	EmblemID *string `json:"emblemId,omitempty"`

	//  Max length = 3, At least 1 CARD LOGO should be entered when EMBOSSER RECORD ACTION = 'A'. When adding a card to an account, the Card Logo is automatically added to the Card Details table on the Base Segment record
	// Max Length: 3
	// Min Length: 0
	// Pattern: ^[0-9]*$
...
// Validate validates this ms card logo table for customer account card add1
func (m *MsCardLogoTableForCustomerAccountCardAdd1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MsCardLogoTableForCustomerAccountCardAdd1) validateCardNumber(formats strfmt.Registry) error {
...
func (m *MsCardLogoTableForCustomerAccountCardAdd1) validateEmblemID(formats strfmt.Registry) error {
...
func (m *MsCardLogoTableForCustomerAccountCardAdd1) validateMultiSchemeCardLogo(formats strfmt.Registry) error {
...
func (m *MsCardLogoTableForCustomerAccountCardAdd1) validateRecordNumber(formats strfmt.Registry) error {
...
func (m *MsCardLogoTableForCustomerAccountCardAdd1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MsCardLogoTableForCustomerAccountCardAdd1) UnmarshalBinary(b []byte) error {
	var res MsCardLogoTableForCustomerAccountCardAdd1
