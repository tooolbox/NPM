...
// CustomerAccountCardAddRequest customer account card add request
//
// swagger:model CustomerAccountCardAddRequest
type CustomerAccountCardAddRequest struct {
	...
	//  Max length = 1, Additional Frequency.
	// Max Length: 1
	// Min Length: 0
	// Pattern: ^[0-9]*$
	AddlFreq *string `json:"addlFreq,omitempty"`

	//  Max length = 17, Additional Transaction Amount.
	// Pattern: ^(-)?[0-9]{1,17}$
	AddlTxnAmt string `json:"addlTxnAmt,omitempty"`

	//  Max length = 9, Additional Transaction Number.
	// Pattern: ^(-)?[0-9]{1,9}$
	AddlTxnNbr string `json:"addlTxnNbr,omitempty"`
	...
	// Min Length: 0
	// Pattern: ^[0-9]*$
	AssocNbrOccurs *string `json:"assocNbrOccurs,omitempty"`

	// Associated party data
	AssocPartyData []*AssocPartyDataForCustomerAccountCardAdd1 `json:"assocPartyData"`
	...
	//  Max length = 17, Maximum amount in monetary units and subunits of ATM cash authorizations allowed for the frequency defined in the FREQ field
	// Pattern: ^(-)?[0-9]{1,17}$
	AtmCashAmount string `json:"atmCashAmount,omitempty"`

	//  Max length = 9, Maximum number of ATM cash authorizations allowed for the frequency defined in the FREQ field
	// Pattern: ^(-)?[0-9]{1,9}$
	...
	//  Max length = 3, Intermediary Code 1.  The input code should exist in the new intermediary code table (AZCI).  If the input code is not found, '000' will be populated in base segment field, and a warning message will be returned in the response message. 2. When an intermediary code value is not supplied on the input message, spaces will be populated in the account base segment field.
	// Max Length: 3
	// Min Length: 0
	...
	//  Max length = 1, Controls Opt in and out. Valid values are: <UL><LI> <EM>0 </EM> Control Opt In</LI> <LI><EM>1</EM> Control Opt Out</LI></UL>
	// Max Length: 1
	// Min Length: 0
	// Pattern: ^[0-9]*$
	...
	//  Max length = 1, Valid values are:<UL><LI><EM> A -</EM> Add Customer </LI><LI><EM>U -</EM> Update Customer </LI><LI><EM>Blank/Space -</EM> No action </LI><LI></UL><BR>NOTE: Marketing Preference data is only added or updated by this service as part of Add or Update to Customer
	// Max Length: 1
	// Min Length: 0
	CustomerRecordAction *string `json:"customerRecordAction,omitempty"`

	//  Max length = 1, CUSTOMER SOURCE
	// Max Length: 1
	// Min Length: 0
	...
	// Format: YYYYMMDD. Date Opened: Date on which the account was opened. NOTE:  if the service Input field equals low values, the OPNED field will contain the current processing date.  Field must be numeric. Field must be a valid Julian date. Date cannot be greater than current processing date. Date cannot be a zero value.
	...
	//  Max length = 11, Bank identifier code (BIC) associated with the Direct Credit account. A SWIFT code is an international bank code that identifies particular banks worldwide. Required if the IBAN flag on ARML12 is equal to 1.
	// Max Length: 11
	// Min Length: 0
	...
	//  Max length = 34, International Banking Account Number (IBAN) associated with the Direct Credit account. This field is required when the IBAN field on ARML12 is 1 and the DD ACCOUNT field is greater than zeros
	// Max Length: 34
	// Min Length: 0
	...
	//  Max length = 1, Account Type. The values are: D = Demand deposit account (checking) S = Savings account. For non-prepaid accounts, valid values are D or S. For prepaid accounts, this field be initialized to a value of D.
	// Max Length: 1
	// Min Length: 0
	DdAchType *string `json:"ddAchType,omitempty"`

	//  Max length = 11, Bank Identifier Code (BIC) associated with the Direct Debit account. A SWIFT code is an international bank code that identifies particular banks worldwide. Required if the IBAN flag on ARML12 is equal to 1.
	// Max Length: 11
	// Min Length: 0
	...
	//  Max length = 34, International Banking Account Number (IBAN) associated with the Direct Debit account. This field is required when the IBAN field on ARML12 is 1 and the DD ACCOUNT field is greater than zeros
	// Max Length: 34
	// Min Length: 0
	...
	//  Max length = 17, Direct Debit amount. For non-prepaid accounts (AMBS-PREPAID-FLAG = 0), field must be numeric. If the DD NOM AMT/% flag is equal to 0 or 3, the amount field must equal zeros. If the DD NOM AMT/% flag is equal to 1 or 2, the amount field must be greater than zeros. If the DD NOM AMT/% flag equals 2, the amount must be greater than zero and less than 100%. NOTE: For prepaid accounts, this field will be initialized to zeros.
	// Pattern: ^(-)?[0-9]{1,17}$
	DdNomAchAmt string `json:"ddNomAchAmt,omitempty"`

	//  Max length = 1, NOM-ACH-AMT-PCT: two part field 0 = Not used. Second part must be blank. 1 = Fixed payment amount. Second part must be an amount 2 = Percentage of account (cycle-ending) balance. Second must be a percentage (max 99%) 3 = Full account (cycle-ending) balance. Second part must be zeros 9 = Percentage of account (cycle-ending minus overlimit amount) balance. Second part must be a percantage (max 99%)
	// Max Length: 1
	// Min Length: 0
	// Pattern: ^[0-9]*$
	...
	//  Max length = 2, Valid values are zeros through 31. If the DUE DATE field on ARML14 equals zeros, the DUE field must equal zeros. If the CYCLE field equals zeros, the DUE field must be greater than zeros
	// Max Length: 2
	// Min Length: 0
	// Pattern: ^[0-9]*$
	...
	//  Max length = 1, Embossed Name Type 1: Type of name for EMBOSSED NAME 1. This field is only used for prepaid cards.  Values are: 0 = Personal name (Default) 3 = Generic name. If you enter 3 for the type and leave the EMBOSSED NAME 1 field blank, the embossed name defaults from the NAME LINE 1 field on ARML39.
	// Max Length: 1
	// Min Length: 0
	// Pattern: ^[0-9]*$
	EmbossedNameType1 *string `json:"embossedNameType1,omitempty"`

	//  Max length = 1, Embossed Name Type 2: Type of name for EMBOSSED NAME 2. This field is only used for prepaid cards.  Values are: 0 = Personal name (Default) 3 = Generic name. If you enter 3 for the type and leave the EMBOSSED NAME 2 field blank, the embossed name defaults from the NAME LINE 2 field on ARML39.
	// Max Length: 1
	// Min Length: 0
	// Pattern: ^[0-9]*$
	EmbossedNameType2 *string `json:"embossedNameType2,omitempty"`

	//  Max length = 1, Valid values are  A = Add Embosser Blank/Space = No action NOTE: for Add Embosser at least one CARD LOGO must be provided in the driver
	// Max Length: 1
	// Min Length: 0
	...
	// Format: YYYYMMDD. Date on which the special pricing controls expire for the account. The PRICING CTRL field identifies the special pricing controls. The EXPIRATION DATE must be greater than the START DATE.
	...
	//  Max length = 17, Fixed payment amount of the credit limit that CMS uses to calculate the payment amount if the PLAN PMT OVRD FLAG is F, X, A.
	// Pattern: ^(-)?[0-9]{1,17}$
	FixedPmtAmt string `json:"fixedPmtAmt,omitempty"`

	//  Max length = 17, Fixed payment amount or percentage of the credit limit that CMS uses to calculate the payment amount if the TEMP FIXD PMT MTD/EXP DATE is F, X, P, A, B or C with a valid date.
	// Pattern: ^(-)?[0-9]{1,17}$
	FixedPmtAmtPct string `json:"fixedPmtAmtPct,omitempty"`

	//  Max length = 7, Fixed payment percentage of the credit limit that CMS uses to calculate the payment amount if the PLAN PMT OVRD FLAG is P, B.
	// Max Length: 7
	// Min Length: 0
	// Pattern: ^[0-9]*$
	...
	//  Max length = 3, Merchant organization number of the employee's home store. Used in Staff Discount products
	// Max Length: 3
	// Min Length: 0
	// Pattern: ^[0-9]*$
	...
	InsuranceProductTable []*InsuranceProductTableForCustomerAccountCardAdd1 `json:"insuranceProductTable"`
	...
	// MAKER COMAKER TABLE
	MakerComakerTable []*MakerComakerTableForCustomerAccountCardAdd1 `json:"makerComakerTable"`

	// marketing channels data
	MarketingChannelsData []*MarketingChannelsDataForCustomerAccountCardAdd1 `json:"marketingChannelsData"`
	...
	MarketingProductsData []*MarketingProductsDataForCustomerAccountCardAdd1 `json:"marketingProductsData"`
	...
	//  Max length = 30, Alphanumeric field used to store the reminder word. Memorable Word Reminder can be 'viewed', 'set up' or 'amended' based on the user access security on the customer record. Memorable Word Reminder allows free form text up to 30 characters. Like the Memorable Word, this field will also be parameterized at the Org level
	// Max Length: 30
	// Min Length: 0
	...
	// 5 Occurrences - Indicates which logos the driver should generate embosser records for.
	MsCardLogoTable []*MsCardLogoTableForCustomerAccountCardAdd1 `json:"msCardLogoTable"`
	...
	//  Max length = 17, Maximum amount in monetary units and subunits of OTC cash authorizations allowed for this Embosser record for the frequency defined in the 'MAXIMUM: FREQ' field on the ARQE03  screen.
	// Pattern: ^(-)?[0-9]{1,17}$
	OtcCashAmount string `json:"otcCashAmount,omitempty"`

	//  Max length = 9, Maximum number of OTC authorizations allowed for the frequency defined in the FREQ field
	// Pattern: ^(-)?[0-9]{1,9}$
	...
	// Format: YYYYMMDD. Date on which the processing control level override starts for the account. The PCT LVL OVERRIDE field identifies the override level in effect.
	...
	//  Max length = 9, ID number of the Smart Card Program. If greater than zero, validate Smart Card Program Definition record is on file. If CARD TECH = 0 (magnetic strip), PROGRAM ID cannot be greater than zero. If not greater than zero, default program id field on the logo record (ARML38) is used.
	// Max Length: 9
	// Min Length: 0
	// Pattern: ^[0-9]*$
	...
	//  Max length = 17, Maximum amount in monetary units and subunits of Retail authorizations allowed for the frequency defined in the FREQ field
	// Pattern: ^(-)?[0-9]{1,17}$
	RetailPurchAmount string `json:"retailPurchAmount,omitempty"`

	//  Max length = 9, Maximum number of  Retail authorizations allowed for the frequency defined in the FREQ field
	// Pattern: ^(-)?[0-9]{1,9}$
	...
	//  Max length = 16, SLF SEL PIN BLOCK
	// Max Length: 16
	// Min Length: 0
	...
	// Format: YYYYMMDD. Date Alternate Customer Start The effective date of the alternate customer address. The default is zeros. The value entered must be a date greater than or equal to the next processing date of the organization associated with the account.
	...
	// Format: YYYYMMDD. Date on which the special pricing controls start for the account. The PRICING CTRL field identifies the special pricing controls. The START DATE must be equal to or greater than the next processing date.
	...
	// Format: YYYYMMDD. Service Fee expiration date: Date on which use of the current fee table override expires. Value must be zeros when Service Charge/Fee table override is not active for the logo (SVC FEE TBL OVRD on ARML14).
	SvcFeeExpDt string `json:"svcFeeExpDt,omitempty"`

	// Format: YYYYMMDD. Service Fee start date: Date on which use of the current fee table override started. Value must be zeros when Service Charge/Fee table override is not active for the logo (SVC FEE TBL OVRD on ARML14).
	SvcFeeStrtDt string `json:"svcFeeStrtDt,omitempty"`

	//  Max length = 3, Service Charge/Fee table pointer indicating which override table is to be used.  Value must be zeros when Service Charge/Fee table override is not active for the logo (SVC FEE TBL OVRD on ARML14).
	// Max Length: 3
	// Min Length: 0
	// Pattern: ^[0-9]*$
	...
	//  Max length = 17, Maximum amount in monetary units and subunits of total cash authorizations(irrespective of the above channels) allowed for the frequency defined in the FREQ field
	// Pattern: ^(-)?[0-9]{1,17}$
	TotalCashAmt string `json:"totalCashAmt,omitempty"`

	//  Max length = 9, Maximum number of  CASH authorizations(irrespective of the above channels) allowed for the frequency defined in the FREQ field
	// Pattern: ^(-)?[0-9]{1,9}$
	...
	//  Max length = 19, This field is only valid for CUSTOMER RECORD ACTION = 'A' The Unique ID is passed to VisionPLUS and stored on the customer name and address record as a new field. Unique ID to be available to be maintained through online screens, batch non-monetary updates, and VMx
	// Max Length: 19
	// Min Length: 0
	...
	//  Max length = 21, User 11 field. This field can be defined by each business to store information that is not provided in other fields in the system but still is necessary because of the business processes.
	// Max Length: 21
	// Min Length: 0
	...
	//  Max length = 20, User application data 3
	// Max Length: 20
	// Min Length: 0
	UserAppl3 *string `json:"userAppl3,omitempty"`
	...
	// Max Length: 1
	// Min Length: 0
	WaiveCashAvailCr *string `json:"waiveCashAvailCr,omitempty"`
	...
	// WAIVE SVC FEES
	WaiveSvcFees []*WaiveSvcFeesForCustomerAccountCardAdd1 `json:"waiveSvcFees"`

	// WAIVE TXN FEE DATA
	WaiveTxnFeeData []*WaiveTxnFeeDataForCustomerAccountCardAdd1 `json:"waiveTxnFeeData"`
...
// Validate validates this customer account card add request
func (m *CustomerAccountCardAddRequest) Validate(formats strfmt.Registry) error {
	var res []error
	...
	if err := m.validateAddlTxnAmt(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateAddlTxnNbr(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateAssocLtrFee1(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateAssocLtrFee2(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateAssocLtrFee3(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateAssocLtrFlag1(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateAssocLtrFlag2(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateAssocLtrFlag3(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateAssocNbrOccurs(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateAssocPartyData(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateAssocStmtFlag1(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateAssocStmtFlag2(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateAssocStmtFlag3(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateCustomerSource(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateUserAppl3(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateWaiveCashAvailCr(formats); err != nil {
		res = append(res, err)
	}
...
func (m *CustomerAccountCardAddRequest) validateAccountLogo(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAccountNumber(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAccountOrganization(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAccountRecordAction(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAccountType(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAcctCtlOvrrd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAcctCustNbrSameInd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAcctGenID(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAcctLimitCheck(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAction(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAddlFreq(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAddlTxnAmt(formats strfmt.Registry) error {

	if swag.IsZero(m.AddlTxnAmt) { // not required
		return nil
	}

	if err := validate.Pattern("addlTxnAmt", "body", string(m.AddlTxnAmt), `^(-)?[0-9]{1,17}$`); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateAddlTxnNbr(formats strfmt.Registry) error {

	if swag.IsZero(m.AddlTxnNbr) { // not required
		return nil
	}

	if err := validate.Pattern("addlTxnNbr", "body", string(m.AddlTxnNbr), `^(-)?[0-9]{1,9}$`); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateAddressLine1(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAddressLine2(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAltCustNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAltCustNbrFlag(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAnnStmtFlg(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAssocLtrFee1(formats strfmt.Registry) error {

	if swag.IsZero(m.AssocLtrFee1) { // not required
		return nil
	}

	if err := validate.MinLength("assocLtrFee1", "body", string(*m.AssocLtrFee1), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("assocLtrFee1", "body", string(*m.AssocLtrFee1), 1); err != nil {
		return err
	}

	if err := validate.Pattern("assocLtrFee1", "body", string(*m.AssocLtrFee1), `^[0-9]*$`); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateAssocLtrFee2(formats strfmt.Registry) error {

	if swag.IsZero(m.AssocLtrFee2) { // not required
		return nil
	}

	if err := validate.MinLength("assocLtrFee2", "body", string(*m.AssocLtrFee2), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("assocLtrFee2", "body", string(*m.AssocLtrFee2), 1); err != nil {
		return err
	}

	if err := validate.Pattern("assocLtrFee2", "body", string(*m.AssocLtrFee2), `^[0-9]*$`); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateAssocLtrFee3(formats strfmt.Registry) error {

	if swag.IsZero(m.AssocLtrFee3) { // not required
		return nil
	}

	if err := validate.MinLength("assocLtrFee3", "body", string(*m.AssocLtrFee3), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("assocLtrFee3", "body", string(*m.AssocLtrFee3), 1); err != nil {
		return err
	}

	if err := validate.Pattern("assocLtrFee3", "body", string(*m.AssocLtrFee3), `^[0-9]*$`); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateAssocLtrFlag1(formats strfmt.Registry) error {

	if swag.IsZero(m.AssocLtrFlag1) { // not required
		return nil
	}

	if err := validate.MinLength("assocLtrFlag1", "body", string(*m.AssocLtrFlag1), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("assocLtrFlag1", "body", string(*m.AssocLtrFlag1), 1); err != nil {
		return err
	}

	if err := validate.Pattern("assocLtrFlag1", "body", string(*m.AssocLtrFlag1), `^[0-9]*$`); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateAssocLtrFlag2(formats strfmt.Registry) error {

	if swag.IsZero(m.AssocLtrFlag2) { // not required
		return nil
	}

	if err := validate.MinLength("assocLtrFlag2", "body", string(*m.AssocLtrFlag2), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("assocLtrFlag2", "body", string(*m.AssocLtrFlag2), 1); err != nil {
		return err
	}

	if err := validate.Pattern("assocLtrFlag2", "body", string(*m.AssocLtrFlag2), `^[0-9]*$`); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateAssocLtrFlag3(formats strfmt.Registry) error {

	if swag.IsZero(m.AssocLtrFlag3) { // not required
		return nil
	}

	if err := validate.MinLength("assocLtrFlag3", "body", string(*m.AssocLtrFlag3), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("assocLtrFlag3", "body", string(*m.AssocLtrFlag3), 1); err != nil {
		return err
	}

	if err := validate.Pattern("assocLtrFlag3", "body", string(*m.AssocLtrFlag3), `^[0-9]*$`); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateAssocNbrOccurs(formats strfmt.Registry) error {

	if swag.IsZero(m.AssocNbrOccurs) { // not required
		return nil
	}

	if err := validate.MinLength("assocNbrOccurs", "body", string(*m.AssocNbrOccurs), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("assocNbrOccurs", "body", string(*m.AssocNbrOccurs), 1); err != nil {
		return err
	}

	if err := validate.Pattern("assocNbrOccurs", "body", string(*m.AssocNbrOccurs), `^[0-9]*$`); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateAssocPartyData(formats strfmt.Registry) error {

	if swag.IsZero(m.AssocPartyData) { // not required
		return nil
	}

	for i := 0; i < len(m.AssocPartyData); i++ {
		if swag.IsZero(m.AssocPartyData[i]) { // not required
			continue
		}

		if m.AssocPartyData[i] != nil {
			if err := m.AssocPartyData[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("assocPartyData" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *CustomerAccountCardAddRequest) validateAssocStmtFlag1(formats strfmt.Registry) error {

	if swag.IsZero(m.AssocStmtFlag1) { // not required
		return nil
	}

	if err := validate.MinLength("assocStmtFlag1", "body", string(*m.AssocStmtFlag1), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("assocStmtFlag1", "body", string(*m.AssocStmtFlag1), 1); err != nil {
		return err
	}

	if err := validate.Pattern("assocStmtFlag1", "body", string(*m.AssocStmtFlag1), `^[0-9]*$`); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateAssocStmtFlag2(formats strfmt.Registry) error {

	if swag.IsZero(m.AssocStmtFlag2) { // not required
		return nil
	}

	if err := validate.MinLength("assocStmtFlag2", "body", string(*m.AssocStmtFlag2), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("assocStmtFlag2", "body", string(*m.AssocStmtFlag2), 1); err != nil {
		return err
	}

	if err := validate.Pattern("assocStmtFlag2", "body", string(*m.AssocStmtFlag2), `^[0-9]*$`); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateAssocStmtFlag3(formats strfmt.Registry) error {

	if swag.IsZero(m.AssocStmtFlag3) { // not required
		return nil
	}

	if err := validate.MinLength("assocStmtFlag3", "body", string(*m.AssocStmtFlag3), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("assocStmtFlag3", "body", string(*m.AssocStmtFlag3), 1); err != nil {
		return err
	}

	if err := validate.Pattern("assocStmtFlag3", "body", string(*m.AssocStmtFlag3), `^[0-9]*$`); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateAtmCashAmount(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAtmCashNumber(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAtmDailyAmount(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAtmPckgReq(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAuthEppOptFlag(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAuthLimitOvrrdFlag(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAuthMsg(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateAuthThres(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateBankCode(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateBillingLevel(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateBlockCode(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateBlockCode1(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateBlockCode2(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateBranchNumber(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateBureauScr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCardActionReason(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCardGenID(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCardStatement(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCardTech(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCardholderType(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCbIndicator(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCcdIntCode(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateChanInd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateClientRefInd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateColatCode(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCommon(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateControlsOptInOut(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateConvChequeOrdering(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateConvChqbookDispatchMethod(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCorresCustNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCrdNbrScm(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCrdtLmtAlert(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCrdtLmtAmt(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCreditLmt(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCrlimBypsInd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCustCrlim(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCustNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCustOrg(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCustUcliPref(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCustomerNumber(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCustomerRecordAction(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateCustomerSource(formats strfmt.Registry) error {

	if swag.IsZero(m.CustomerSource) { // not required
		return nil
	}

	if err := validate.MinLength("customerSource", "body", string(*m.CustomerSource), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("customerSource", "body", string(*m.CustomerSource), 1); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateCycle(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDateCardExpr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDcAccountNumber(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDcAccountType(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDcAmount(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDcBic(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDcGenID(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDcIban(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDcPlan(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDcRequestDay(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDcRequestDayIndicator(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDcRtBankid(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdAchAccountNumber(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdAchReqDay(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdAchType(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdBic(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdCreditBalance(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdDailyFrequency(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdDaysFctn(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdDaysNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdIban(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdInterimPayments(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdNomAchAmt(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdNomAmtPctFlag(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdPayment(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdRtBankid(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdaAcctNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDdaRtngNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDefaultCashPlan(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDefaultPromoPlan(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDefaultRetailPlan(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDeliveryPointSuffix(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDigitalCardInd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDisabilityInd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateDue(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEdGenderCode(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEdPostalCode(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEdUser1(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEdUser2(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEdUser3(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEdUser4(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEdUser5(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEdUser6(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEdUser7(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEdUser8(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmbCity(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmbPinCommPref(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmbPinMemWord(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmbPinMobileNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmblm(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmbossedName1(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmbossedName2(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmbossedNameType1(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmbossedNameType2(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmbosserRecordAction(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmbossingCard(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmbossingMail(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmbossingReq(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmbrName1(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmbrName2(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmpID(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateEmployeeCode(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateFiscalYearEnd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateFixedPmtAmt(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateFixedPmtAmtPct(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateFixedPmtPct(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateForeignBilling(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateForeignInd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateFppPlanNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateFrequency(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateFsFlag(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateHomeStoreNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateHomeStoreOrg(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateIbsAcctDflt(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateIbsDdaAcctNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateIbsDdaRtngNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateIbsSavAcctNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateIbsSavRtngNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateInHouseScr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateIncome(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateInstCrCardNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateInstCrFbsc(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateInstCrNbrGenID(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateInsuranceProductTable(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateIssuanceID(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateIssueBranch1st(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateIssueDelivOption1st(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateLangCode(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMakerComakerTable(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMarketingChannelsData(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMarketingOptOut(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMarketingProductsData(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMemoBillCurrency(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMemorableWord(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMemorableWordReminder(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMini(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMiscScr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMiscUser1(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMiscUser10(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMiscUser11(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMiscUser12(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMiscUser2(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMiscUser3(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMiscUser4(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMiscUser5(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMiscUser6(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMiscUser7(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMiscUser8(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMiscUser9(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMobDeviceID(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMobPiAllowed(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMobProvStatus(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMsCardLogoTable(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateMultiSchemeCardSetID(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateNbrCardsRequested(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateNewAcctCampaign(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOfferCodeOvrd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOfficerCode(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOfflinePin(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOndemDcBic(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOndemDcIban(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOtaSmsInd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOtaThres(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOtbSmsInd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOtbThres(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOtcCashAmount(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOtcCashNumber(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOverLmtAlert(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOwnerCoownerInd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOwningBranch(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateOwningStore(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validatePctLevelOverride(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validatePinOverride(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validatePinSuppression(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validatePlanPmtOvrdFlag(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validatePlasticID(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validatePmtDueAlert(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validatePmtDueRemDays(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validatePricingCtrl(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validatePrimary(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateProgramID(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateQuasiCashAmount(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateQuasiCashAmt(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateQuasiCashNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateQuasiCashNumber(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateReissueBranch(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateReissueBranchDelivOption(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateRelationshipNumber(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateResidenceID(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateRetailPurchAmount(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateRetailPurchNumber(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateRewdSchemeIden(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSalesExec1(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSalesExec2(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSalesExec3(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSdpProcessType(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSecurecodeAct(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateShortName(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSlfSelPinBlock(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSmsAlerts(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSmsGenBankingInd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSnglCshLmt(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSource(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSourceChannel(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSpndLmtAlert(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSpndLmtAmt(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateStPr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSuppFeeInd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSvcFeeTable(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSweepAccount(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateSweepIndicator(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateTempCreditLine(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateTempFixedPmtAmtPct(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateTempFixedPmtMthd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateTermCond(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateTotalCashAmt(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateTotalCashNumber(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateTotalTxnAmount(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateTotalTxnNumber(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateTransactionLimitQuasi(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUniqueID(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUser10(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUser11(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUser9(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAcctNbr(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAmt1(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAmt10(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAmt11(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAmt12(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAmt13(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAmt14(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAmt2(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAmt3(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAmt4(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAmt5(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAmt6(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAmt7(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAmt8(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAmt9(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAppl1(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAppl2(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserAppl3(formats strfmt.Registry) error {

	if swag.IsZero(m.UserAppl3) { // not required
		return nil
	}

	if err := validate.MinLength("userAppl3", "body", string(*m.UserAppl3), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("userAppl3", "body", string(*m.UserAppl3), 20); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateUserCode1(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserCode10(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserCode11(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserCode12(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserCode13(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserCode14(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserCode2(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserCode3(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserCode4(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserCode5(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserCode6(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserCode7(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserCode8(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateUserCode9(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateVipStatus(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveCashAdvFee(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveCashAvailCr(formats strfmt.Registry) error {

	if swag.IsZero(m.WaiveCashAvailCr) { // not required
		return nil
	}

	if err := validate.MinLength("waiveCashAvailCr", "body", string(*m.WaiveCashAvailCr), 0); err != nil {
		return err
	}

	if err := validate.MaxLength("waiveCashAvailCr", "body", string(*m.WaiveCashAvailCr), 1); err != nil {
		return err
	}
...
func (m *CustomerAccountCardAddRequest) validateWaiveCycSpendFee(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveIntrChg(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveLateChg(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveLateNotices(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveLtrChg(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveMembership(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveNsfFeeInd(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveOverlimitFee(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveOvlmNotice(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaivePrepaidFeeDormancy(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaivePrepaidFeeRefund(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaivePrepaidFeeStmt(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveSuppMemFlag(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveSvcFees(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveTxnFeeData(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveUserFee1(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveUserFee2(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveUserFee3(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveUserFee4(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveUserFee5(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWaiveUserFee6(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) validateWmPercent(formats strfmt.Registry) error {
...
func (m *CustomerAccountCardAddRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CustomerAccountCardAddRequest) UnmarshalBinary(b []byte) error {
	var res CustomerAccountCardAddRequest
